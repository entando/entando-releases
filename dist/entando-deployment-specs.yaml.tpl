...
data:
  app-builder: >-
    {"version":"6.1.201","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  busybox: >-
  ...
  entando-de-app-eap: >-
    {"version":"6.1.127","executable-type":"jvm","registry":"docker.io","organization":"entando"}
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: operator
          image: "docker.io/entando/entando-k8s-controller-coordinator:6.2.7"
