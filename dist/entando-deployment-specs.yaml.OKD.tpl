...
data:
  ...
  entando-de-app-eap: >-
    {"version":"6.1.88","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  ...
  entando-k8s-keycloak-controller: >-
    {"version":"6.1.14","executable-type":"jvm","registry":"docker.io","organization":"entando"}
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: operator
          image: "docker.io/entando/entando-k8s-controller-coordinator:6.1.9"
