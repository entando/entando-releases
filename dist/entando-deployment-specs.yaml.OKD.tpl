...
data:
  app-builder: >-
    {"version":"6.1.117","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  entando-avatar-plugin: >-
    {"version":"6.0.5","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  entando-component-manager: >-
    {"version":"6.0.52","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  entando-de-app-eap: >-
    {"version":"6.1.65","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  entando-de-app-wildfly: >-
    {"version":"6.1.65","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  entando-k8s-app-controller: >-
    {"version":"6.1.5","executable-type":"jvm","registry":"docker.io","organization":"entando"}
  ...
  entando-k8s-keycloak-controller: >-
    {"version":"6.1.13","executable-type":"jvm","registry":"docker.io","organization":"entando"}
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: operator
          image: "docker.io/entando/entando-k8s-controller-coordinator:6.1.7"
